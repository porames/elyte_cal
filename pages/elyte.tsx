        ...
        <div className="space-y-3">
            ...
            {value < 3.5 && value > 3 && Number(oralDrugMeq) > 0 && (
                <SectionCard eyebrow="Mild hypokalemia" title="K 40–80 mEq/day">
                    ...
                    <p>
                        Concentration
                        <InlineNumberInput value={Number(oralDrugMeq)} onChange={setoralDrugMeq} placeholder="mEq" />
                        mEq / tablet
                    </p>
                    <p>
                    ...
                    <p>
                        KCl
                        <InlineNumberInput value={solDrugMeq} onChange={setSolDrugMeq} placeholder="mEq" />
                        mEq /
                        <InlineNumberInput value={solDrugMl} onChange={setSolDrugMl} placeholder="mL" />
                        mL
                    </p>
                    <p>
            ...
            {value <= 3 && value >= 2.5 && Number(oralDrugMeq) > 0 && (
                <SectionCard eyebrow="Moderate hypokalemia" title="K 120 mEq/day">
                    ...
                    <p>
                        5%DN/2 1000 mL + KCl
                        <InlineNumberInput value={IVKConc} onChange={setIVKConc} placeholder="mEq" />
                        mEq → rate <span className="mono">{Math.floor((Number(KRate) * 1000) / Number(IVKConc))}</span> mL/h
                    </p>
                    <p>
                        K infusion rate =
                        <InlineNumberInput value={KRate} onChange={setKRate} placeholder="" />
                        mEq/h
                    </p>
                </SectionCard>
            )}
            {value < 2.5 &&
                <SectionCard eyebrow="Severe hypokalemia">
                    ...
                    <p>
                        5%DN/2 100 mL + KCl
                        <InlineNumberInput value={centralIVKConc} onChange={setCentralIVKConc} placeholder="mEq" />
                        mEq → rate <span className="mono">{Math.floor((Number(centralKRate) * 100) / Number(centralIVKConc))}</span> mL/h
                    </p>
                    <p>
                        K infusion rate =
                        <InlineNumberInput value={centralKRate} onChange={setCentralKRate} placeholder="" />
                        mEq/h
                    </p>
                </SectionCard>
            }
        ...
        <div className="space-y-3">
            ...
            {value > 145 && patient_weight && (
                <SectionCard eyebrow="Hypernatremia" title="Target ~8 mEq/L/day lowering">
                    <p>
                        Target Na
                        <InlineNumberInput value={targetNa} onChange={setTargetNa} placeholder="mEq" />
                    </p>
                    {targetNa && (
